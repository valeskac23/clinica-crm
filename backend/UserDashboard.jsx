...
const UserDashboard = () => {
  ...
  return (
    ...
    >
      ...
      <nav className="bg-white/30 backdrop-blur-md border-b border-white/20 p-4 shadow-lg">
        <div className="max-w-7xl mx-auto flex justify-between items-center">
          ...
          <div className="flex items-center gap-3">
            ...
            <button
              onClick={logout}
              className="p-2.5 text-slate-700 hover:bg-red-500/20 hover:text-red-700 rounded-xl transition-all"
              title="Cerrar Sesión"
            >
              <LogOut size={22} />
            </button>
